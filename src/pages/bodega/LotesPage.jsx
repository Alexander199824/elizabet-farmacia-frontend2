...
const LotesPage = () => {
  ...
  const handleProductSelect = async (productId) => {
    ...
    try {
      ...
      // Si el producto tiene proveedor, pre-seleccionarlo y bloquearlo
      if (product.supplierId) {
        ...
        // Si no tiene proveedor, dejar el campo vacío (opcional)
        setFormData(prev => ({
          ...prev,
          productId: product.id,
          supplierId: ''
  ...
  const handleOpenForm = async (batch = null) => {
    if (batch) {
      ...
      // Cargar información del producto para mostrar correctamente el proveedor
      if (batch.productId) {
        try {
